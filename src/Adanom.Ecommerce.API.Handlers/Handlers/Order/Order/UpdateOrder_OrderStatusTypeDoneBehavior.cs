...
{
    public sealed class UpdateOrder_OrderStatusTypeDoneBehavior : IPipelineBehavior<UpdateOrder_OrderStatusType, bool>
    {
        #region Fields
        ...
        public UpdateOrder_OrderStatusTypeDoneBehavior(IMediator mediator)
        {
