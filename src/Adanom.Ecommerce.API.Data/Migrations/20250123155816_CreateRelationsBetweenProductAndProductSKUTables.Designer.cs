...
namespace Adanom.Ecommerce.API.Data.Migrations
{
    ...
    [Migration("20250123155816_CreateRelationsBetweenProductAndProductSKUTables")]
    partial class CreateRelationsBetweenProductAndProductSKUTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.Order", b =>
                {
                    ...
                    b.Property<decimal?>("DiscountByOrderPaymentType")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");
                    ...
                    b.Property<decimal>("ShippingFeeTotal")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.OrderPayment", b =>
                {
                    ...
                    b.Property<byte>("OrderPaymentType")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.Product_ProductSKU_Mapping", b =>
                {
                    b.Property<long>("ProductId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("ProductId", "ProductSKUId");

                    b.HasIndex("ProductSKUId", "ProductId")
                        .IsUnique();

                    b.ToTable("Product_ProductSKU_Mappings");
                });
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.ReturnRequest", b =>
                {
                    ...
                    b.Property<string>("DisapprovedReasonMessage")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.ShippingProvider", b =>
                {
                    ...
                    b.Property<decimal>("MinimumFreeShippingOrderGrandTotal")
                        .HasPrecision(10, 2)
                        .HasColumnType("decimal(10,2)");
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.StockReservation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.Product_ProductSKU_Mapping", b =>
                {
                    b.HasOne("Adanom.Ecommerce.API.Data.Models.Product", "Product")
                        .WithMany("Product_ProductSKU_Mappings")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.Product", b =>
                {
                    ...
                    b.Navigation("Product_ProductSKU_Mappings");
