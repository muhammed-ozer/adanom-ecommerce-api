...
namespace Adanom.Ecommerce.API.Data.Migrations
{
    ...
    [Migration("20240427073645_MakeuserEmailAndUserNameAsNotNullable")]
    partial class MakeuserEmailAndUserNameAsNotNullable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.BillingAddress", b =>
                {
                    ...
                    b.Property<long>("TaxAdministrationId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.Brand_Image_Mapping", b =>
                {
                    ...
                    b.HasIndex("BrandId", "ImageId")
                        .IsUnique();

                    b.ToTable("Brand_Image_Mappings");
                });

            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.Brand_MetaInformation_Mapping", b =>
                {
                    b.Property<long>("BrandId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("BrandId", "MetaInformationId");

                    b.HasIndex("MetaInformationId", "BrandId")
                        .IsUnique();

                    b.ToTable("Brand_MetaInformation_Mappings");
                });
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.MetaInformation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.Order", b =>
                {
                    ...
                    b.Property<string>("ShippingTransactionCode")
                        .HasMaxLength(250)
                        .HasColumnType("nvarchar(250)");
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.ProductCategory", b =>
                {
                    ...
                    b.Property<byte>("ProductCategoryLevel")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.ProductCategory_Image_Mapping", b =>
                {
                    ...
                    b.HasIndex("ProductCategoryId", "ImageId")
                        .IsUnique();

                    b.ToTable("ProductCategory_Image_Mappings");
                });

            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.ProductCategory_MetaInformation_Mapping", b =>
                {
                    b.Property<long>("ProductCategoryId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("ProductCategoryId", "MetaInformationId");

                    b.HasIndex("MetaInformationId", "ProductCategoryId")
                        .IsUnique();

                    b.ToTable("ProductCategory_MetaInformation_Mappings");
                });
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.ProductTax", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.Product_Image_Mapping", b =>
                {
                    b.Property<long>("ProductId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("Product_Image_Mappings");
                });

            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.Product_MetaInformation_Mapping", b =>
                {
                    b.Property<long>("ProductId")
                        .HasColumnType("bigint");
                    ...
                    b.HasKey("ProductId", "MetaInformationId");

                    b.HasIndex("MetaInformationId", "ProductId")
                        .IsUnique();

                    b.ToTable("Product_MetaInformation_Mappings");
                });
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.TaxAdministration", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.User", b =>
                {
                    ...
                    b.Property<byte>("DefaultDiscountRate")
                        .HasColumnType("tinyint");
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.BillingAddress", b =>
                {
                    ...
                    b.HasOne("Adanom.Ecommerce.API.Data.Models.TaxAdministration", "TaxAdministration")
                        .WithMany()
                    ...
                    b.Navigation("TaxAdministration");
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.Brand_Image_Mapping", b =>
                {
                    b.HasOne("Adanom.Ecommerce.API.Data.Models.Brand", "Brand")
                        .WithMany("Brand_Image_Mappings")
                        .HasForeignKey("BrandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Adanom.Ecommerce.API.Data.Models.Image", "Image")
                        .WithMany("Brand_Image_Mappings")
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.Brand_MetaInformation_Mapping", b =>
                {
                    b.HasOne("Adanom.Ecommerce.API.Data.Models.Brand", "Brand")
                        .WithMany("Brand_MetaInformation_Mappings")
                        .HasForeignKey("BrandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Adanom.Ecommerce.API.Data.Models.MetaInformation", "MetaInformation")
                        .WithMany("Brand_MetaInformation_Mappings")
                        .HasForeignKey("MetaInformationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Brand");

                    b.Navigation("MetaInformation");
                });
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.Order", b =>
                {
                    b.HasOne("Adanom.Ecommerce.API.Data.Models.BillingAddress", "BillingAddress")
                        .WithMany()
                        .HasForeignKey("BillingAddressId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Adanom.Ecommerce.API.Data.Models.OrderPayment", "Payment")
                        .WithMany()
                        .HasForeignKey("PaymentId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Adanom.Ecommerce.API.Data.Models.ShippingAddress", "ShippingAddress")
                        .WithMany()
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.ProductCategory_Image_Mapping", b =>
                {
                    b.HasOne("Adanom.Ecommerce.API.Data.Models.Image", "Image")
                        .WithMany("ProductCategory_Image_Mappings")
                        .HasForeignKey("ImageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.ProductCategory_MetaInformation_Mapping", b =>
                {
                    b.HasOne("Adanom.Ecommerce.API.Data.Models.MetaInformation", "MetaInformation")
                        .WithMany("ProductCategory_MetaInformation_Mappings")
                        .HasForeignKey("MetaInformationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.ProductPrice", b =>
                {
                    b.HasOne("Adanom.Ecommerce.API.Data.Models.ProductTax", "ProductTax")
                        .WithMany()
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.Product_Image_Mapping", b =>
                {
                    b.HasOne("Adanom.Ecommerce.API.Data.Models.Image", "Image")
                        .WithMany("Product_Image_Mappings")
                        .HasForeignKey("ImageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.Product_MetaInformation_Mapping", b =>
                {
                    b.HasOne("Adanom.Ecommerce.API.Data.Models.MetaInformation", "MetaInformation")
                        .WithMany("Product_MetaInformation_Mappings")
                        .HasForeignKey("MetaInformationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.Brand", b =>
                {
                    b.Navigation("Brand_Image_Mappings");

                    b.Navigation("Brand_MetaInformation_Mappings");
                });
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.Image", b =>
                {
                    ...
                    b.Navigation("ProductCategory_Image_Mappings");

                    b.Navigation("Product_Image_Mappings");
                });
            ...
            modelBuilder.Entity("Adanom.Ecommerce.API.Data.Models.MetaInformation", b =>
                {
                    ...
                    b.Navigation("ProductCategory_MetaInformation_Mappings");

                    b.Navigation("Product_MetaInformation_Mappings");
                });
